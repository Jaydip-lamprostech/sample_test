...
import type { Address } from "@dethcrypto/eth-sdk";
...
// var getArbitrumOneSdk = require("@dethcrypto/eth-sdk")
...
export const getAllData = async (signer: Signer) => {
  ...
  const dataPromises = {
    ...
    reservedForVesting: vestedTND.then((tnd: any) => sdk.vTND.getPairAmount(address, tnd))
  }
